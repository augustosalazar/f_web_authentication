...
class ProductController extends GetxController with UiLoggy {
  ...
  getProducts() async {
    loggy.info("ProductController: Getting products");
  ...
  void deleteProducts() async {
    loggy.info("ProductController: Delete all products");
    isLoading.value = true;
